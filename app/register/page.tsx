...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 px-4 sm:px-6 lg:px-8 overflow-hidden" style={{ wordBreak: 'normal', overflowWrap: 'normal' }}>
      {/* Animated Background */}
